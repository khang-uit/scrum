    ...
    return (
        <>
            ...
            <header className="page-header">
                <img className="img" src="/Admin/logoadmin.png" alt="" />
                <nav>
                    ...
                    <button className="toggle-mob-menu" aria-expanded="false" aria-label="open menu">
                        <svg style={{ width: 20, height: 20, ariaHidden: 'true' }}>
                            <use href="#down"></use>
                        </svg>
                    </button>
            ...
            <section className="page-content">
                ...
                <section >
                    <p className="tittle-name input">POST TITTLE </p>               
                         <input className="input-tittle"></input>
                    <p className="category-name input">CATEGORY </p>               
                         <input className="input-tittle"></input>
                    <p className="img-name input">IMAGE </p>               
                         <input type="file" className="input-tittle" accept="image/*"></input>
                    <article style={{height: 'fit-content'}} >
                        <ReactQuill style={{ width: '100%', height: '100%' }} modules={{
                            toolbar: [
